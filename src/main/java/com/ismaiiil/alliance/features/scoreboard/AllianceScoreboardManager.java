...
public class AllianceScoreboardManager {
    ...
    private static final HashMap<String, Scoreboard> playerScoreboards = new HashMap<>();
    //player name - AllianceObjective
    private static final HashMap<String, AllianceObjective> playerObjectives = new HashMap<>();
    ...
    public static Scoreboard getPlayerScoreboard(Player player){
        ...
        if (_obj != null) {
            ...
            AllianceLogger.log(Level.WARNING, "The scoreboard for player " + player + " does not exist");
        }
        return null;
    }
    ...
    private static TextComponent createObjectiveTextComponent(EnumObjective myObjective){
        switch (myObjective){
            ...
            default:
                AllianceLogger.log(Level.SEVERE, "The objective " + myObjective + " does not exist");
                return null;
        }
    }
