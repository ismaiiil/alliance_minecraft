...
import com.ismaiiil.alliance.features.claims.cache.implemented.BalanceCache;
import com.ismaiiil.alliance.features.claims.cache.implemented.BorderCache;
import com.ismaiiil.alliance.features.claims.cache.implemented.SelectorCache;
import com.ismaiiil.alliance.features.claims.corner.Corner;
import com.ismaiiil.alliance.features.claims.corner.CornerTypes;
...
public class AllianceRegionManager {
    ...
    public static void init(){
        ...
        defaultRadius = alliancePlugin.defaultRegionRadius;
    ...
    public static void highlightRegionsForPlayer(Player p) {
        int highlightRadius = alliancePlugin.highlightRegionRadius;
        //highlight edges of regions within a certain area
        Location targetLocation = p.getLocation();

        var corners = getCornersAsBlockVector(targetLocation,highlightRadius,targetLocation.getBlockY()+highlightRadius, targetLocation.getBlockY()-highlightRadius);
